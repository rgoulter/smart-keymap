/********************************** (C) COPYRIGHT
 ******************************** File Name          : hidkbdservice.c Author :
...
static uint8_t hidReportBootKeyOutProps =
    GATT_PROP_READ | GATT_PROP_WRITE | GATT_PROP_WRITE_NO_RSP;
...
static gattAttribute_t hidAttrTbl[] = {
    ...
    // HID Boot Keyboard Input Report characteristic client characteristic
    // configuration
    {{ATT_BT_UUID_SIZE, clientCharCfgUUID},
     GATT_PERMIT_READ | GATT_PERMIT_ENCRYPT_WRITE,
     0,
...
enum {
  ...
  HID_REPORT_KEY_IN_DECL_IDX,  // HID Report characteristic, key input
                               // declaration
  HID_REPORT_KEY_IN_IDX,       // HID Report characteristic, key input
  HID_REPORT_KEY_IN_CCCD_IDX, // HID Report characteristic client characteristic
                              // configuration
  ...
  HID_BOOT_KEY_IN_CCCD_IDX,   // HID Boot Keyboard Input Report characteristic
  ...
  HID_REPORT_REF_FEATURE_IDX  // HID Report Reference characteristic descriptor,
                              // feature
};
