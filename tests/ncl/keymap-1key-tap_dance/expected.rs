...
pub mod init {
    ...
    pub mod key_system {
        ...
        pub struct System {
            ...
            tap_dance: smart_keymap::key::tap_dance::System<
                Ref,
                [smart_keymap::key::tap_dance::Key<Ref, { super::TAP_DANCE_MAX_DEFINITIONS }>;
                    super::TAP_DANCE],
    ...
    /// The key references.
    pub const KEY_REFS: [Ref; KEY_COUNT] = [key_system::Ref::TapDance(
