...
pub mod init {
    ...
    pub mod key_system {
        ...
        pub struct System {
            ...
            tap_hold: smart_keymap::key::tap_hold::System<
                Ref,
                [smart_keymap::key::tap_hold::Key<Ref>; super::TAP_HOLD],
            >,
        }
    ...
    pub const KEY_REFS: [Ref; KEY_COUNT] = [
        ...
        key_system::Ref::TapHold(smart_keymap::key::tap_hold::Ref(1)),
        key_system::Ref::TapHold(smart_keymap::key::tap_hold::Ref(2)),
        key_system::Ref::TapHold(smart_keymap::key::tap_hold::Ref(3)),
        ...
        key_system::Ref::TapHold(smart_keymap::key::tap_hold::Ref(5)),
        key_system::Ref::TapHold(smart_keymap::key::tap_hold::Ref(6)),
        key_system::Ref::TapHold(smart_keymap::key::tap_hold::Ref(7)),
