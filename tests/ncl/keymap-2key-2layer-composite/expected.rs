...
pub mod init {
    ...
    pub type KeyDefinitionsType = Keys2<
        ...
        crate::key::layered::LayeredKey<crate::key::composite::TapHoldKey>,
        Context,
        Event,
    >;
    ...
    pub const KEY_DEFINITIONS: KeyDefinitionsType = Keys2::new((
        crate::key::tap_hold::Key::new(
            ...
            crate::key::composite::BaseKey::layer_modifier(crate::key::layered::ModifierKey::Hold(
                0,
            )),
        ),
        crate::key::layered::LayeredKey::new(
            ...
            [Some(crate::key::composite::TapHoldKey::Pass(
                crate::key::composite::BaseKey::keyboard(crate::key::keyboard::Key::new(6)),
            ))],
        ),
    ));
}
